...
const a2 = z.createContext(void 0);
function l2({ children: s, defaultTheme: c = "light", switchable: u = !1 }) {
...
const go = "06-42874405",
  ...
  p2 = "https://www.supersaas.nl/schedule/balanergy/Balanergy",
  h2 =
...
const v2 = "https://www.supersaas.nl/schedule/balanergy/Balanergy";
function y2() {
  return o.jsxs("div", {
...
const vh = "https://www.supersaas.nl/schedule/balanergy/Balanergy",
  vo = "06-42874405",
...
function A2({ title: s, subtitle: c, duration: u, price: r, description: f }) {
  return o.jsxs("div", {
...
function D2() {
  return (yh() ? window.vam : bh()) || "production";
}
function Ou() {
  return D2() === "development";
}
function _2(s) {
  return s.scriptSrc
    ? Rl(s.scriptSrc)
...
function B2(s, c) {
  ...
  M2(r.mode);
  const f = { sdkn: C2 + (r.framework ? `/${r.framework}` : ""), sdkv: z2 };
  return (
    ...
    { beforeSend: r.beforeSend, src: _2(r), dataset: f }
  );
}
function Rl(s) {
...
function R2(s = { debug: !0 }, c) {
  var u;
  if (!yh()) return;
  const { beforeSend: r, src: f, dataset: m } = B2(s, c);
  if (
    (O2(),
...
function Y2(s) {
  return (
    ...
    z.useEffect(() => {
      s.route && s.path && H2({ route: s.route, path: s.path });
    }, [s.route, s.path]),
    null
  );
}
    ...
    children: o.jsx(l2, {
      ...
      children: o.jsxs(u1, {
        ...
        children: [
          ...
          o.jsx(Y2, { "data-loc": "client/src/App.tsx:50" }),
        ],
      }),
    }),
  });
