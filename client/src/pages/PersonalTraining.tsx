    ...
    >
      ...
      <main className="flex-1">
        ...
        <section className="py-12 bg-white">
          <div className="container max-w-3xl text-left" style={{ marginRight: "0px", marginLeft: "5px" }}>
            <p
              className="font-body text-base leading-relaxed mb-6"
              style={{ color: "#6B6560" }}
            >
              Wil jij yoga of Body Balance op een individueel afgestemde manier
              leren? Bij Balanergy bieden we persoonlijke trainingen waarbij jij
              centraal staat. Of je nu beginner bent of al ervaring hebt, we
              passen het programma volledig aan jouw kennis, ervaring en
              persoonlijke doelen.
            </p>
            <p
              ...
              style={{ color: "#6B6560" }}
            >
              Je krijgt 1 op 1 begeleiding met directe feedback en correctie op
              je practice. Alle trainingen zijn inclusief gebruik van een
              yogamat indien gewenst, en vinden plaats in de praktijkruimte van
              Balanergy.
            </p>
          </div>
        </section>
        ...
        <section className="py-12 bg-white">
          <div className="container max-w-3xl text-left">
            ...
            <div className="space-y-6 mb-8">
              <div>
                ...
                <p className="font-body text-base" style={{ color: "#6B6560" }}>
                  Losse lessen in de praktijkruimte van Balanergy zijn online
                  boekbaar via onze agenda.
                </p>
              </div>
              <div>
                <h3
                ...
                <p className="font-body text-base" style={{ color: "#6B6560" }}>
                  Voor trainingspakketten of lessen op locatie, neem contact op
                  via telefoon of email. We plannen dan samen een moment in dat
                  bij jou past.
                </p>
              </div>
              <div>
                ...
                <p className="font-body text-base" style={{ color: "#6B6560" }}>
                  Body Balance, Hatha yoga of Power Yoga lessen voor bedrijven
            ...
            >
              ...
              <p className="font-body text-base" style={{ color: "#6B6560" }}>
                Personal Training is ook superleuk en origineel om cadeau te
                doen! Geef iemand de kans om op een persoonlijke manier fit en
                gezond te worden.
              </p>
            </div>
