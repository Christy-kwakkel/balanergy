          ...
          <div className="container relative z-10">
            <div className="max-w-2xl">
              ...
              >
                Breng je energie
                <br />
                <span style={{ fontStyle: "italic", color: "#E8D5C4" }}>
                  weer in balans
                </span>
              </h1>
              <p
                ...
                style={{ color: "#F5F1ED" }}
              >
                Balanergy is de praktijk van Mascha Kwakkel in IJsselmuiden —
                centraal gelegen tussen Kampen en Zwolle. Hier staat jouw
                lichaam en geest centraal.
              </p>
              <div className="flex flex-col gap-4 justify-start">
                ...
                <Link href="/behandelingen">
                  <a
                    className="px-6 py-3 rounded font-body text-sm font-semibold border-2 text-center transition-all hover:opacity-90 w-full sm:w-auto"
        ...
        <section className="py-16 md:py-24">
          <div className="container">
            <div className="max-w-3xl">
              ...
              >
                <p>
                  Balanergy biedt Thaise yogamassage, ontspanningsmassages,
                  anti-stress massages, sportmassage en voetreflexologie — maar
                  ook technieklessen yoga en Personal Training in IJsselmuiden.
                </p>
                <p>
                  Balanergy is er om jouw fysieke en mentale gezondheid te
        ...
        <section className="py-16 md:py-24">
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <Link href="/behandelingen">
                <div
                  className="group bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-all cursor-pointer"
                ...
                >
                  ...
                  <p
                    ...
                    style={{ color: "#6B6560" }}
                  >
                    Ontdek onze volledige aanbod van massages en behandelingen
                    met prijzen.
                  </p>
                  <div
              ...
              <Link href="/arrangementen">
                ...
                >
                  ...
                  <p
                    ...
                    style={{ color: "#6B6560" }}
                  >
                    Ontdek onze speciale arrangementen, seizoensgebonden
        ...
        <section className="py-16 md:py-24">
          <div className="container">
            ...
            <p className="font-body text-lg mb-8" style={{ color: "#6B6560" }}>
              Kies je behandeling en boek direct online via onze agenda, of neem
              contact met ons op
            </p>
            <div className="flex flex-col gap-4 justify-start">
              <a
              ...
              <Link href="/contact">
                <a
                  className="px-8 py-3 rounded font-body text-sm font-semibold border-2 transition-all hover:opacity-90 w-full sm:w-auto"
