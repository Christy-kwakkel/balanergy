      ...
      <main className="flex-1">
        ...
        <section className="py-12">
          <div className="container">
            ...
            <p className="font-body text-lg mb-8" style={{ color: "#6B6560" }}>
              Korte workshops waarin je de basisprincipes van massage leert.
              Perfecte introductie voor beginners of aanvulling voor ervaren
              therapeuten.
            </p>
        ...
        <section className="py-12 bg-white">
          <div className="container">
            ...
            <p className="font-body text-lg mb-8" style={{ color: "#6B6560" }}>
              Volledige professionele opleidingen met certificering. Ideaal voor
              degenen die een massagepraktijk willen starten of hun vaardigheden
              willen verdiepen.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch">
              {trainings.map(t => (
