...
const seizoensArrangementen = [
  {
    ...
    subtitle: "Tafel",
    description: "Stimulerende massage met westerse en oosterse technieken om je lichaam energie te geven. Start met scrub van rug, nek en schouders, gevolgd door massage van alle lichaamsdelen met aandacht voor voeten.",
  ...
  },
  {
    ...
    subtitle: "Tafel",
    description: "Start met voetbad in kaneel of sinaasappel etherische olie. Daarna balsem en verwarmde massage van rug, nek, schouders en bilspieren. Bij 90 minuten ook voor- en achterkant benen.",
  ...
  },
  {
    ...
    subtitle: "Mat",
    description: "Warm voetbad met kaneel of sinaasappel olie, therapeutische balsem en Thaise massage met acupressuur en stretch technieken. Keuze tussen ontspannende of therapeutische massage.",
...
const vasteArrangementen = [
  {
    ...
    subtitle: "Tafel",
    description: "Ontspannende massage met focus op rug, nek, schouders, handen, voeten en hoofd. In overleg bepalen we waar jij het meest behoefte aan hebt. Inclusief miniflesje anti-stress olie om mee naar huis te nemen.",
  ...
  },
  {
    ...
    subtitle: "Mat & Tafel",
    description: "Combinatie van mat en tafel: voetbad, yogastretches op mat voor benen, heupen en rug, vervolgens massage op tafel van rug, nek, schouders en hoofd. Zowel ontspannend als therapeutisch.",
  ...
  },
  {
    ...
    subtitle: "Mat",
    description: "Thaise yogamassage met 15-20 minuten voetreflexologie voor preventie en opsporing van aandoeningen. Warm voetenbad en kopje kruiden- of vruchtenthee. Bij 90 minuten hele lichaam en meer tijd per onderdeel.",
  ...
  },
  {
    ...
    subtitle: "Tafel",
    description: "Start met voetenbad en kopje kruiden- of vruchtenthee, daarna stevige scrub van rug en achterkant benen. Gevolgd door massage naar keuze: stevige of ontspannende. Bij 90 minuten hele lichaam.",
  ...
  },
  {
    ...
    description: "Speciaal ontworpen voor zwangeren (maar ook voor anderen): lavendelvoetbad met kruidenthee, ontspannende massage van hoofd, gezicht, nek, schouders, armen en voeten in veilige positie. Bij 90 minuten ook rug en benen in stabiele zijligging.",
